...
static const DrvLineSensorArray s_line_sensors = {
    ...
    LINE_LOW_VALUE,
    {
        { LINE_A_PORT, LINE_CCD0_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
        { LINE_A_PORT, LINE_CCD1_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
        { LINE_A_PORT, LINE_CCD2_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
        { LINE_A_PORT, LINE_CCD3_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
        { LINE_B_PORT, LINE_CCD4_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
        { LINE_B_PORT, LINE_CCD5_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
        { LINE_B_PORT, LINE_CCD6_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
#ifdef LINE_CCD7_PIN
        { LINE_B_PORT, LINE_CCD7_PIN, BSP_LINE_SENSOR_ACTIVE_LOW },
#endif
    },
};
